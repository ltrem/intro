...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('jquery_js' => array(0 => array(0 => ($this->targetDirs[3].'\\app/../vendor/components/jquery/jquery.min.js')), 1 => array(0 => '?yui_js'), 2 => array()), 'bootstrap_js' => array(0 => array(0 => ($this->targetDirs[3].'\\app/../vendor/twitter/bootstrap/js/transition.js'), 1 => ($this->targetDirs[3].'\\app/../vendor/twitter/bootstrap/js/alert.js'), 2 => ($this->targetDirs[3].'\\app/../vendor/twitter/bootstrap/js/modal.js'), 3 => ($this->targetDirs[3].'\\app/../vendor/twitter/bootstrap/js/dropdown.js'), 4 => ($this->targetDirs[3].'\\app/../vendor/twitter/bootstrap/js/scrollspy.js'), 5 => ($this->targetDirs[3].'\\app/../vendor/twitter/bootstrap/js/tab.js'), 6 => ($this->targetDirs[3].'\\app/../vendor/twitter/bootstrap/js/tooltip.js'), 7 => ($this->targetDirs[3].'\\app/../vendor/twitter/bootstrap/js/popover.js'), 8 => ($this->targetDirs[3].'\\app/../vendor/twitter/bootstrap/js/button.js'), 9 => ($this->targetDirs[3].'\\app/../vendor/twitter/bootstrap/js/collapse.js'), 10 => ($this->targetDirs[3].'\\app/../vendor/twitter/bootstrap/js/carousel.js'), 11 => ($this->targetDirs[3].'\\app/../vendor/twitter/bootstrap/js/affix.js')), 1 => array(0 => '?yui_js'), 2 => array()), 'bootstrap_less' => array(0 => array(0 => ($this->targetDirs[3].'\\app/../vendor/twitter/bootstrap/less/bootstrap.less')), 1 => array(0 => 'lessphp', 1 => 'cssembed'), 2 => array()))), 'config');
    ...
    {
        $this->services['assetic.filter.cssembed'] = $instance = new \Assetic\Filter\CssEmbedFilter(($this->targetDirs[3].'\\app/Resources/java/cssembed-0.4.5.jar'), 'C:\\OpenJDK7\\bin\\java.exe');
    ...
    protected function getAssetic_Filter_LessphpService()
    {
        ...
        $instance->setPresets(array('my_variable' => '#000'));
    ...
    {
        $this->services['assetic.filter.yui_js'] = $instance = new \Assetic\Filter\Yui\JsCompressorFilter(($this->targetDirs[3].'\\app/Resources/java/yuicompressor-2.4.8.jar'), 'C:\\OpenJDK7\\bin\\java.exe');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'intro', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'ADesignsCalendarBundle' => 'ADesigns\\CalendarBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_1ae8772a164661f8d8cf2b48ecbbdfe0ffbb26b9513b48ee87931e74225d19e3');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('18af51a32b4e05feca5eae5e792e78d258778f29');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '18af51a32b4e05feca5eae5e792e78d258778f29',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '18af51a32b4e05feca5eae5e792e78d258778f29',
            ...
            'assetic.java.bin' => 'C:\\OpenJDK7\\bin\\java.exe',
            ...
            'assetic.filter.cssembed.java' => 'C:\\OpenJDK7\\bin\\java.exe',
            'assetic.filter.cssembed.jar' => ($this->targetDirs[3].'\\app/Resources/java/cssembed-0.4.5.jar'),
            ...
            'assetic.filter.yui_js.java' => 'C:\\OpenJDK7\\bin\\java.exe',
            'assetic.filter.yui_js.jar' => ($this->targetDirs[3].'\\app/Resources/java/yuicompressor-2.4.8.jar'),
